...
WHERE cast_members.character = 'James Bond' ORDER BY year ASC;
...
WHERE actors.id = '303' ORDER BY genres.name, movies.title;
...
WHERE genres.id = '2' ORDER BY year ASC LIMIT 5;
